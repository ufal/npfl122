...
class Network:
    def __init__(self, env, args):
        ...
        # Prepare an optimizer with the default learning rate and a loss
...
if __name__ == "__main__":
    ...
    env = wrappers.EvaluationWrapper(memory_game_environment.make(args.cards), args.seed, evaluate_for=args.evaluate_for, report_each=args.evaluate_for)
