...
We start by selecting action $A_1$, 
and get a reward $R_1$. 
The indices denote at which time step the action/reward occured.
We then repeat the process by selecting actions $A_2$, $A_3$, …
