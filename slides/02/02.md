...
$$\begin{aligned}
\big\|Bv_1 - Bv_2\big\|_∞
  &= \big\|\max_a 𝔼\big[R_{t+1} + γ v_1(S_{t+1})\big] - \max_a 𝔼\big[R_{t+1} + γ v_2(S_{t+1})\big]\big\|_∞ \\
  &= \big\|\max_a \big(𝔼\big[R_{t+1} + γ v_1(S_{t+1})\big] - \max_a 𝔼\big[R_{t+1} + γ v_2(S_{t+1})\big]\big)\big\|_∞ \\
  &≤ \big\|\max_a \big(𝔼\big[R_{t+1} + γ v_1(S_{t+1})\big] - 𝔼\big[R_{t+1} + γ v_2(S_{t+1})\big]\big)\big\|_∞ \\
  &= \max_a\Big( \Big\| 𝔼\big[R_{t+1} + γ v_1(S_{t+1})\big] - 𝔼\big[R_{t+1} + γ v_2(S_{t+1})\big]\Big\|_∞\Big) \\
