...
To prove the Gumbel-Max trick, we first reformulate it to the following. Let
$l_i$ be logits of a categorical distribution (so that $π_i ∝ e^{l_i}$) and
let $g_i ∼ \operatorname{Gumbel}(0, 1)$. Then
