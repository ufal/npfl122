...
![w=100%,v=middle](mc_estimation.pdf)
...
![w=60%,h=center](mc_estimation_example.pdf)
...
~~~
![w=70%,h=center](td_estimation.pdf)
...
![w=60%,h=center](td_nstep_estimation.pdf)

---
# Temporal Difference Semi-Gradient Policy Evaluation

![w=100%,v=middle](td_estimation_example.pdf)
