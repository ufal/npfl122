...
![w=90%,h=center](../02/monte_carlo_exploring_starts.pdf)
...
Assume that $b$ and $π$ are two distributions and let $x_i$ be the samples of $b$.
...
$$𝔼_{x∼π}[f(x)] ∼ ∑_i \frac{π(x_i)}{b(x_i)} f(x_i)$$
